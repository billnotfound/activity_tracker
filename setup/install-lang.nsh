...
LangString SEC_NTP_NAME       ${LANG_ENGLISH} "Use NTP time verification"
LangString SEC_NTP_DESC       ${LANG_ENGLISH} "Use network standard time (NTP/HTTP) as reference for system time anomalies. Local-only detection when disabled. On by default."
...
LangString SEC_NTP_NAME       ${LANG_SIMPCHINESE} "使用 NTP 时间校验"
LangString SEC_NTP_DESC       ${LANG_SIMPCHINESE} "使用网络标准时间（NTP/HTTP）作为系统时间异常的参照。关闭后仅使用本地检测。默认开启。"
